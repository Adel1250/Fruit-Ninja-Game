...
public class SpecialFruit1 implements GameObject {
    ...
    public ArrayList<ImageIcon> getBufferedImage() {
        ...
        ImageIcon i1 = new ImageIcon("GameImages\\SpecialFruit1.png");
        ImageIcon i2 = new ImageIcon("GameImages\\SpecialFruit13.png");
        ImageIcon i3 = new ImageIcon("GameImages\\SpecialFruit14.png");
        arrImages.add(i1);
        arrImages.add(i2);
        arrImages.add(i3);
        return arrImages;
