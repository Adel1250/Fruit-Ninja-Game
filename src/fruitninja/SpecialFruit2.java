...
public class SpecialFruit2 implements GameObject {
    ...
    public ArrayList<ImageIcon> getBufferedImage() {
        ...
        ImageIcon i1 = new ImageIcon("GameImages\\SpecialFruit2.png");
        ImageIcon i2 = new ImageIcon("GameImages\\SpecialFruit23.png");
        ImageIcon i3 = new ImageIcon("GameImages\\SpecialFruit24.png");
        arrImages.add(i1);
        arrImages.add(i2);
        arrImages.add(i3);
        return arrImages;
